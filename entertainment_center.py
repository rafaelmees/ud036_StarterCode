...
avengers_infinity_war = media.Movie(
    ...
    (
        'Homem de Ferro, Thor, Hulk e os Vingadores se unem para combater '
        'seu inimigo mais poderoso, o maligno Thanos. Em uma missão para '
        'coletar todas as seis pedras infinitas, Thanos planeja usá-las '
        'para infligir sua vontade maléfica sobre a realidade.'
    ),
...
black_panther = media.Movie(
    ...
    (
        ...
        'que perde o seu pai e viaja para os Estados Unidos, onde tem '
        'contato com os Vingadores. Entre as suas habilidades estão a '
        'velocidade, inteligência e os sentidos apurados.'
    ),
...
thor_ragnarok = media.Movie(
    ...
    (
        ...
        'de seu mundo, que está nas mãos da poderosa e implacável vilã Hela.'
    ),
